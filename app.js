...
const pokeName1 = document.querySelector(".poke-name");
const pokeId = document.querySelector(".poke-id");
const pokeWeight = document.querySelector(".poke-weight");
const pokeHeight = document.querySelector(".poke-height");
const pokeTypeOne = document.querySelector(".poke-type-one");
const pokeTypeTwo = document.querySelector(".poke-type-two");
const imgScreen = document.querySelector(".screen__image");
            ...
            fetch("https://pokeapi.co/api/v2/pokemon/" + pokeName)
                .then((res) =>
                    res.json().then((data3) => {
                        ...
                        pokeName1.textContent = data3.name;
                        pokeId.textContent = data3.id;
                        pokeWeight.textContent = data3.weight;
                        pokeHeight.textContent = data3.height;
                        console.log(data3);
                        ...
                        pokeTypeOne.textContent = pokesTypes1["type"]["name"];
                        if (pokesTypes2) {
